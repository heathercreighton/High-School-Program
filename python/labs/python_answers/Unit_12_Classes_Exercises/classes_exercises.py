...
def main():
    manipulate_string = StringManipulation("Hello, for you to - here's a string to CHANGE")
    manipulate_string.string_reversal("taco cat")
    manipulate_string.removing_case()
    manipulate_string.is_vowel(searching="ffff")
    manipulate_string.is_palindrome(searching="ffffff")
    manipulate_string.short_hand()
    manipulate_string.pig_latin()
